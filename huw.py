...
class HUWebshop(object):
    ...
    def renderpackettemplate(self, template="homepage.html", packet={}):
        ...
        if template == "homepage.html":
            packet['r_products'] = self.recommendations(4,'none',1)
            packet['r_type'] = list(self.recommendationtypes.keys())[1]
            packet['r_string'] = list(self.recommendationtypes.values())[1]
        return render_template(template, packet=packet)

    """ ..:: Recommendation Functions ::.. """

    def recommendations(self, count, productid, recom_type):
        ...
        resp = requests.get(self.recseraddress+"/"+session['profile_id']+"/"+str(count)+"/"+str(productid)+"/"
                            +str(recom_type))
    ...
    def productpage(self, cat1=None, cat2=None, cat3=None, cat4=None, page=1):
        ...
        return self.renderpackettemplate('products.html', {'products': prodlist, \
            ...
            'r_products': self.recommendations(4,'none',0), \
